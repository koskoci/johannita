...
set :application_name, 'johannita'
set :domain, '206.189.55.142'
set :user, 'deploy'
set :deploy_to, "/home/deploy/app"
set :repository, 'https://github.com/koskoci/johannita.git'
set :branch, 'master'
...
set :shared_dirs, fetch(:shared_dirs, []).push('storage') - ['public/assets']
